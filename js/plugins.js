...
class GridToFullscreenEffect {
    constructor(e, n, t = {}) {
        this.container = e,
            ...
            t.timing.latestStart = t.timing.latestStart || .5,
            ...
            t.flipBeizerControls.c0.x = t.flipBeizerControls.c0.x || .5,
            t.flipBeizerControls.c0.y = t.flipBeizerControls.c0.y || .5,
            t.flipBeizerControls.c1 = t.flipBeizerControls.c1 || {},
            t.flipBeizerControls.c1.x = t.flipBeizerControls.c1.x || .5,
            t.flipBeizerControls.c1.y = t.flipBeizerControls.c1.y || .5,
            this.options = t,
            this.uniforms = {
    ...
    init() {
        ...
        this.mesh = new THREE.Mesh(n, o),
            ...
            this.options.scrollContainer && this.options.scrollContainer.addEventListener("scroll", (e => {
    ...
    toGrid() {
        this.isFullscreen && !this.isAnimating && (this.isAnimating = !0,
            this.options.onToGridStart && this.options.onToGridStart({
            ...
            this.tween = TweenLite.to(this.uniforms.uProgress, this.options.timing.duration, {
                ...
                onComplete: () => {
                    this.isAnimating = !1,
                        ...
                        this.resetUniforms(),
                        this.render(),
                        this.options.onToGridFinish && this.options.onToGridFinish({
                            index: -1,
    ...
    toFullscreen(e, n) {
        if (!this.isFullscreen && !this.isAnimating) {
            ...
            this.itemsWrapper.style.zIndex = 0,
                ...
                this.options.onToFullscreenStart && this.options.onToFullscreenStart({
                    index: this.currentImageIndex
                }),
                this.tween = TweenLite.to(this.uniforms.uProgress, this.options.timing.duration, {
                    value: 1,
                    ...
                    onComplete: () => {
                        this.isAnimating = !1,
                            this.isFullscreen = !0,
                            this.options.onToFullscreenFinish && this.options.onToFullscreenFinish({
                                index: this.currentImageIndex
                            })
                    }
                })
    ...
    onResize(e) {
        this.camera.aspect = window.innerWidth / window.innerHeight,
            ...
            this.renderer.setSize(window.innerWidth, window.innerHeight),
            this.currentImageIndex > -1 && (this.recalculateUniforms(e),
                this.render())
    }
}
var activations = {
