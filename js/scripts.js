            ...
            imagesLoaded('body', function () {
                ...
                setTimeout(function () {
                    ...
                    gsap.to($(".showcase-carousel .clapat-slider .clapat-slide-active .slide-inner"), {
                        duration: 1.8, yPercent: 0, delay: 0.7, ease: Power4.easeOut, onComplete: function () {
                    ...
                    init: function () {
                        ...
                        if ($('body').hasClass("show-loader")) {
                            ...
                            imagesLoaded('body', function () {
                                ...
                                gsap.to($(".showcase-carousel .clapat-slider .clapat-slide-active .slide-inner"), {
                                    duration: 1.2, yPercent: 0, delay: 0.2, ease: Power4.easeOut, onComplete: function () {
                                        $('body').removeClass(" disable-scroll");
                                    }
                                });
            ...
            function listView() {
                ...
                if (!grid.classList.contains('list-grid')) {
                    ...
                    gsap.to($('.clapat-item .section-image'), {
                        duration: 0.5, opacity: 0, scale: 0.5, stagger: 0.05, ease: "power3.inOut",
                        onComplete: function () {
                    ...
                    gsap.to($('.clapat-item .section-image'), {
                        duration: 0.5, width: "100%", scale: 0.9, ease: "power3.inOut",
                        onComplete: function () {
